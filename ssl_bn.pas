...
var
   ...
   BN_generate_prime: function(ret: PBIGNUM;bits: TC_INT;safe: TC_INT; _add: PBIGNUM; _rem: PBIGNUM;	callback: BN_cb_1;cb_arg: pointer): TC_INT; cdecl = nil;
   ...
   BN_BLINDING_is_current_thread: function(b: PBN_BLINDING): TC_INT; cdecl = nil;
...
begin
  if @BN_new = nil then
   begin
       ...
       @BN_CTX_init:= LoadFunctionCLib('BN_CTX_init', false);
       ...
       @BN_init:= LoadFunctionCLib('BN_init', false);
       ...
       @BN_MONT_CTX_init:= LoadFunctionCLib('BN_MONT_CTX_init', false);
       ...
       @BN_BLINDING_get_thread_id:= LoadFunctionCLib('BN_BLINDING_get_thread_id', false);
       @BN_BLINDING_set_thread_id:= LoadFunctionCLib('BN_BLINDING_set_thread_id', false);
       @BN_BLINDING_set_current_thread:= LoadFunctionCLib('BN_BLINDING_set_current_thread', false);
       @BN_BLINDING_is_current_thread:= LoadFunctionCLib('BN_BLINDING_is_current_thread', false);

       @BN_BLINDING_thread_id:= LoadFunctionCLib('BN_BLINDING_thread_id', false);
       ...
       @BN_RECP_CTX_init:= LoadFunctionCLib('BN_RECP_CTX_init', false);
       ...
       @bn_expand2:= LoadFunctionCLib('bn_expand2', false);
       @RAND_pseudo_bytes:= LoadFunctionCLib('RAND_pseudo_bytes');
       @bn_mul_add_words:= LoadFunctionCLib('bn_mul_add_words', false);
       @bn_mul_words:= LoadFunctionCLib('bn_mul_words', false);
       @bn_div_words:= LoadFunctionCLib('bn_div_words', false);
       @bn_add_words:= LoadFunctionCLib('bn_add_words', false);
       @bn_sub_words:= LoadFunctionCLib('bn_sub_words', false);
       @bn_sqr_words:= LoadFunctionCLib('bn_sqr_words', false);
       @get_rfc2409_prime_768:= LoadFunctionCLib('get_rfc2409_prime_768', false);
       @get_rfc2409_prime_1024:= LoadFunctionCLib('get_rfc2409_prime_1024', false);
       @get_rfc3526_prime_1536:= LoadFunctionCLib('get_rfc3526_prime_1536', false);
       @get_rfc3526_prime_2048:= LoadFunctionCLib('get_rfc3526_prime_2048', false);
       @get_rfc3526_prime_3072:= LoadFunctionCLib('get_rfc3526_prime_3072', false);
       @get_rfc3526_prime_4096:= LoadFunctionCLib('get_rfc3526_prime_4096', false);
       @get_rfc3526_prime_6144:= LoadFunctionCLib('get_rfc3526_prime_6144', false);
       @get_rfc3526_prime_8192:= LoadFunctionCLib('get_rfc3526_prime_8192', false);
